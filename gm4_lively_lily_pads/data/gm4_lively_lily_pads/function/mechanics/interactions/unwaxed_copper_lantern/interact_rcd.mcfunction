...
# item usage
execute if score $wax_used gm4_llp.data matches 1 run item modify entity @s[gamemode=!creative] weapon.mainhand gm4:minus_one
execute if score $wax_used gm4_llp.data matches 1 run swing @s mainhand
execute if score $wax_used gm4_llp.data matches 2 run item modify entity @s[gamemode=!creative] weapon.offhand gm4:minus_one
