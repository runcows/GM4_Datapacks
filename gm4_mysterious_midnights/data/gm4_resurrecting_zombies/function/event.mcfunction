...
execute as @e[type=item,x=0] if items entity @s contents minecraft:rotten_flesh if predicate gm4:on_ground run function gm4_resurrecting_zombies:mark_rotten_flesh
