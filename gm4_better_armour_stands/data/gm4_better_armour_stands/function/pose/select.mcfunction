...
execute unless score @s gm4_bas_mode matches 1.. if entity @a[tag=gm4_bas_active,limit=1,predicate=gm4_better_armour_stands:select/base,predicate=!gm4:sneaking] run function gm4_better_armour_stands:pose/select/move/move
execute unless score @s gm4_bas_mode matches 1.. if entity @a[tag=gm4_bas_active,limit=1,predicate=gm4_better_armour_stands:select/base,predicate=gm4:sneaking] run function gm4_better_armour_stands:pose/select/rotate
tp @s ~ ~ ~
