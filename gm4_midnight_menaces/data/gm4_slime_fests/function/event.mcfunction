...
# resurrecting slimes
execute as @e[type=minecraft:item,x=0,predicate=gm4:on_ground] if items entity @s contents minecraft:slime_ball run function gm4_slime_fests:mark_slime_ball
