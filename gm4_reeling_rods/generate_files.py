...
def create_select_type(ctx: Context, entities: CSV):
    lines = [
        ...
        "",
        "# apply barbed damage",
        "execute if data storage gm4_reeling_rods:temp enchanted.barbed if data entity @s Health unless data entity @s Invulnerable run function gm4_reeling_rods:fished/apply_barbed_damage with storage gm4_reeling_rods:temp enchanted.barbed",
        "",
