...
execute unless predicate gm4:sneaking as @e[type=#gm4_vecto_shamir:vehicle,tag=gm4_vecto_vehicle,distance=..2] if score @s gm4_vecto_id = $current gm4_vecto_id run team leave @s
