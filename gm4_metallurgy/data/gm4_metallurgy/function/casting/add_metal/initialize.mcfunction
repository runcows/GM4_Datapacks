...
data modify storage gm4_metallurgy:temp/item/ore gm4_metallurgy set from entity @e[type=item,tag=gm4_ml_in_animation,dx=0,dz=0,predicate=gm4_metallurgy:is_castable,predicate=gm4:on_ground,limit=1] Item.components."minecraft:custom_data".gm4_metallurgy
...
execute as @e[type=item,tag=!gm4_ml_in_animation,dx=0,dz=0,predicate=gm4_metallurgy:is_castable,predicate=gm4:on_ground,limit=1] run data merge entity @s {Motion:[0.0,0.35,0.0],PickupDelay:30,Tags:["gm4_ml_in_animation"]}
