...
kill @e[type=item,limit=1,dx=0,dy=0,dz=0,predicate=gm4_metallurgy:is_clay_ball,predicate=gm4:on_ground]
kill @e[type=item,limit=1,dx=0,dy=0,dz=0,predicate=gm4_metallurgy:is_obsidian,predicate=gm4:on_ground]
