...
execute if score @s gm4_ml_heat matches 50..89 align xyz if entity @e[type=item,predicate=gm4_metallurgy:is_castable,predicate=gm4:on_ground,dx=0,dy=0,dz=0] run function gm4_metallurgy:casting/add_metal/initialize
